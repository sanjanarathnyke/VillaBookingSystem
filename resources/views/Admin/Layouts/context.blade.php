        ...
        <div class="navbar-header">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="py-lg-2 pr-lg-2">
                                    <img src="{{ asset('dashboard-assets/images/illustrator/1.png') }}" alt=""
            ...
            <div class="d-flex">
                ...
                <div class="dropdown d-inline-block language-switch">
                    <button type="button" class="btn header-item" data-bs-toggle="dropdown" aria-haspopup="true"
                        aria-expanded="false">
                        <img id="header-lang-img" src="{{ asset('dashboard-assets/images/flags/us.jpg') }}"
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="eng">
                            <img src="{{ asset('dashboard-assets/images/flags/us.jpg') }}" alt="user-image" class="me-1"
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0">
                        ...
                        <div data-simplebar style="max-height: 270px;">
                            ...
                            <a class="notification-item text-reset" href="#!">
                                <div class="d-flex border-bottom align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="{{ asset('dashboard-assets/images/brands/behance.png') }}"
                                            alt="behance">
                                    </div>
                                    <div class="flex-grow-1 ms-4">
                            ...
                            <a class="notification-item text-reset" href="#!">
                                <div class="d-flex border-bottom align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="{{ asset('dashboard-assets/images/brands/dribbble.png') }}"
                                            alt="dribbble">
                                    </div>
                                    <div class="flex-grow-1 ms-4">
                            ...
                            <a class="notification-item text-reset" href="#!">
                                <div class="d-flex border-bottom align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="{{ asset('dashboard-assets/images/brands/dropbox.png') }}"
                                            alt="dropbox">
                                    </div>
                                    <div class="flex-grow-1 ms-4">
                                        <h6 class="mb-0">Dropbox</h6>
                                        <p class="font-size-12 text-muted mb-0">Keep life organized and work moving—all
                                            in one place</p>
                                    </div>
                                </div>
                            </a><!-- end dropdown item -->
                            ...
                            <a class="notification-item text-reset" href="#!">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="{{ asset('dashboard-assets/images/brands/github.png') }}"
                                            alt="github">
                                    </div>
                                    <div class="flex-grow-1 ms-4">
                                ...
                                <div class="d-flex border-bottom align-items-start">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="text-muted">
                                            <p class="mb-1 font-size-13">Your task changed an issue from "In Progress"
                                                to <span class="badge badge-success-subtle">Review</span></p>
...
{{-- // ...and so on for all other image paths --}}
