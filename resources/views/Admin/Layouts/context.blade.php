                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="py-lg-2 pr-lg-2">
                                        <img src="{{ asset('dashboard-assets/images/illustrator/1.png') }}" alt="" class="img-fluid mx-auto" style="max-height: 250px;">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0">
                            ...
                            <div data-simplebar style="max-height: 270px;">
                                ...
                                <a class="notification-item text-reset" href="#!">
                                    <div class="d-flex border-bottom align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="{{ asset('dashboard-assets/images/brands/behance.png') }}" alt="behance">
                                        </div>
                                        <div class="flex-grow-1 ms-4">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            <a href="{{ route('villa-bookings') }}">
                                ...
                                <span class="menu-item">Villa Bookings</span>
                            </a>
                        </li>
                    </ul>
                </div>
